## A simple eye tracker using the cornea brightness distribution
...
while True:
    ...
    if Detected:
        ...
        Position = "center"
        if bright_dist < center_ratio - .05:
            Position = "right"
        if bright_dist > center_ratio + .05:
            Position = "left"
    ...
    ## In PG we are adding objects to a surface, In OpenCV, you are modifying a frame using functions.
